...
fs.writeFileSync(path.join(__dirname, 'frontend/src/components/CourseDetailsModal.jsx'), modalContent, 'utf8');
console.log('Successfully wrote new CourseDetailsModal.jsx');
